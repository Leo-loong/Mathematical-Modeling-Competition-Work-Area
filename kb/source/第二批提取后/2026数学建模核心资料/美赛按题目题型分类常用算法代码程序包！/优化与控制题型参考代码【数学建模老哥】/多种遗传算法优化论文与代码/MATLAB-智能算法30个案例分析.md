...
|---|---|---|
|本案例的目录为：|本案例的目录为：||
|第十五章基于混合粒子群算法的TSP 搜索算法|第十五章基于混合粒子群算法的TSP 搜索算法|第十五章基于混合粒子群算法的TSP 搜索算法|
...
|第 18 章基于鱼群算法的函数寻优算法 1、人工鱼群算法原理|Col2|Col3|
|---|---|---|
...
|向前进一步，即到达位置；如果位置不比当前位置食物浓度更高，则继续巡视视野内的其|向前进一步，即到达位置；如果位置不比当前位置食物浓度更高，则继续巡视视野内的其|向前进一步，即到达位置；如果位置不比当前位置食物浓度更高，则继续巡视视野内的其|
...
|图 20-1 400 个随机样本数据||
|**2**、案例目录：|**2**、案例目录：|
|第20 章基于遗传模拟退火算法的聚类算法|第20 章基于遗传模拟退火算法的聚类算法|
|20.1理论基础|20.1理论基础|
...
第 25 章有导师学习神经网络的回归拟合——基于近红外光谱的汽油辛烷值预测
...
|的等7 种离子的含量作为判别因素，试利用竞争神经网络和SOFM 神经网络分别建立判别|的等7 种离子的含量作为判别因素，试利用竞争神经网络和SOFM 神经网络分别建立判别|的等7 种离子的含量作为判别因素，试利用竞争神经网络和SOFM 神经网络分别建立判别|的等7 种离子的含量作为判别因素，试利用竞争神经网络和SOFM 神经网络分别建立判别|的等7 种离子的含量作为判别因素，试利用竞争神经网络和SOFM 神经网络分别建立判别|
...
<!-- 第 94 页 -->
第 28 章支持向量机的分类——基于乳腺组织电阻抗特性的乳腺癌诊断
...
|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|（3）学习率的选择敏感。学习率对神经网络的性能影响较大，必须选择合适的，才能获|
|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|得较为理想的网络。若太小，则算法收敛速度很慢，训练过程耗时较长；反之，若太大，|
|则训练过程可能不稳定（收敛）。|||||||
