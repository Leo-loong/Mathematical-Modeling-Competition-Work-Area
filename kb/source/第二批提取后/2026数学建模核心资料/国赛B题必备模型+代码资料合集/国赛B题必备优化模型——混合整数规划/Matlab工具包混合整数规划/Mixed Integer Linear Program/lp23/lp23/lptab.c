...
static const short yyrline[] = { 0,
    33,    41,    45,    46,    50,    51,    56,    59,    66,    87,
    88,    91,    92,    95,    98,   101,   102,   103,   106,   107,
   112,   112,   118,   120,   121,   131,   132,   137,   137,   143,
   145,   154,   163,   175,   179,   183,   186,   194
};

static const char * const yytname[] = {   "$","error","$undefined.","VAR","CONS",
