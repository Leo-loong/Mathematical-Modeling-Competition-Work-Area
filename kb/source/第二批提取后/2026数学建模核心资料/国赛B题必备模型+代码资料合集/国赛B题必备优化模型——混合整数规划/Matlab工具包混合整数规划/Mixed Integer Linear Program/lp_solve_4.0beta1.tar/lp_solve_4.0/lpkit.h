...
typedef int abortfunc(void *lp, void *userhandle);
typedef void logfunc(void *lp, void *userhandle, char *buf);
typedef void *msgfunc(void *lp, void *userhandle, int message);
