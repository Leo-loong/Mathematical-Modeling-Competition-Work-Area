...
static short yyact[] = {
	 ...
	 -28,  257,  -30,  -21,  258,  257,  -33,  -41,  261,  259, 
	 -42,  264,   -6,   -2,  -34,  259,  258,  257,  -30,   -2, 
	 258,  257,  -37,  257,  -38,  257,  -30,   -2,  -34,  259, 
	 258,  257,  -36,  -39,   -7,  263,  262,  257,  -33,  -40, 
	 262,  259,  -35,  257,   -1
};
static short yypact[] = {
...
static short yygo[] = {
	  ...
	  -1,  -24,  -19,   -4,  -44,  -46,  -45,    3,  -48,  -47, 
	   9,  -10,   -8,  -16,   10,  -11,   -5,  -50,  -49,    4, 
...
static short yypgo[] = {
	  ...
	  42,   41,   28,   27,   21,   21,   21,   20,   18,    9, 
	  15,   11,    1,    0,    3,    3,    6,    6,   16,   16, 
...
short yyrmap[] = {
	  ...
	  29,   27,   22,   20,   18,   17,   16,   15,   14,    9, 
	   8,    6,    1,    2,    3,    4,    5,    7,   12,   13, 
...
short yysmap[] = {
	  ...
	  17,    9,   32,   21,   57,   54,   46,   48,   55,   56, 
	  33,   34,    0,   40,   26,   39,   25,   52,   36,   49, 
...
#line 64 "lp.y"
  ...
  if((Lin_term_count  > 1) || Solve_dual)
    Rows++;
...
case YYr14: {	/* int_declaration :  int_declarator vars END_C */
#line 94 "lp.y"
Having_ints = 1;
} break;
...
#line 145 "lp.y"
  ...
  if (    (isign || make_neg)
      && !(isign && make_neg)) 
    var_store(Last_var, Rows, (REAL)-1 * Scale_factor);
  else
    var_store(Last_var, Rows, (REAL)1 * Scale_factor);
  isign = 0;
