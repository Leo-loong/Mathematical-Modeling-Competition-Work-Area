GEATbx: Function tbxdbga

# Documentation of tbxdbga

Index of Functions of GEA Toolbox for Matlab

## Function Synopsis

[xnew, GOPTIONS] = tbxdbga(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);

## Help text

 ToolBoX Distributed Breeder Genetic Algorithm

 This function implements the distributed breeder genetic algorithm.

 Syntax:  [xnew, GOPTIONS] = tbxdbga(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)
 ...
 See also: geamain, scrgtx01, tbxmpga, tbxdbin, tbxloga, chekgopt
