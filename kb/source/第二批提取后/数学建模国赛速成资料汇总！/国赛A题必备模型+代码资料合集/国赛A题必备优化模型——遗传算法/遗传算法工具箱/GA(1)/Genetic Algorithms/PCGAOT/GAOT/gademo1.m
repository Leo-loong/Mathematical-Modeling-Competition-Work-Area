...
%   function .m file, here is gademo1E.m

pause 				% Strike any key to look at gademo1E.m
type gademo1E.m
...
%   The initial routine will do this for you.

pause 				% Strike any key for help on initial
clc
help initial
pause 					% Strke any key to continue.
clc
%   Let's create a random starting popluation of size 10.
initPop=initial(10,[0 9],'gademo1E');
pause 					% Strike any key to continue.
...
[x endPop] = ga([0 9],'gademo1E',[],initPop,[1e-6 1 1],'maxGenT',1,...
  'normGeoS',[0.08],['arithX'],[2],'nonUnifM',[2 1 3]);
...
[x endPop] = ga([0 9],'gademo1E',[],initPop,[1e-6 1 1],'maxGenT',25,...
  'normGeoS',[0.08],['arithX'],[2],'nonUnifM',[2 1 3]);
x %The best found
% And plot the resulting the resulting population
