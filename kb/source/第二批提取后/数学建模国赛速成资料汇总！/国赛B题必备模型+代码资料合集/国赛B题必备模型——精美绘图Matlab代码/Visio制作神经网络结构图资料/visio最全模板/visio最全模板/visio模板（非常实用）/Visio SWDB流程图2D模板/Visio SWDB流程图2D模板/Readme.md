To access these shapes in Visio:

1. Copy the stencil files (*.vss) to the "My Shapes" folder in your "Documents" or "My Documents" folder, which is located on a path that looks similar to this:
