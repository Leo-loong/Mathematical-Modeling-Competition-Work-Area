...
空间曲线
1. 一条曲线
例在区间[0，10π]画出参数曲线 x=sint,y=cost,
z=t.
MATLAB liti8
解  t=0:pi/50:10*pi;
plot3(sin(t),cos(t),t)
...
<!-- 第 19 页 -->
例在区间[0,2π]画sin(x)的图形，并加注图例“自变量
X”、“函数Y”、“示意图”, 并加格栅.
...
例将屏幕分割为四块，并分别画出y=sin(x)，z=cos(x)，a=sin(x)×cos(x),b=sin(x)/cos(x).
MATLAB liti7
返回
