GEATbx: Function tbxdbin

# Documentation of tbxdbin

Index of Functions of GEA Toolbox for Matlab

## Function Synopsis

[xnew, GOPTIONS] = tbxdbin(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10);

## Help text

 ToolBoX Distributed Binary/Integer Genetic Algorithm

 This function implements the distributed binary genetic algorithm.

 Syntax:  [xnew, GOPTIONS] = tbxdbin(FUN, GOPTIONSIN, VLB, VUB, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)
 ...
 See also: geamain, scrgtx01, tbxdbga, tbxmpga, tbxloga
