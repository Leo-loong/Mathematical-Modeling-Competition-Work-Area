...
例如  一块石头重量记为1，打碎分成n小块，各块的重量分别记为：w1,w2,…wn
则可得成对比较矩阵
由右面矩阵可以看出，
层次单排序及其一致性检验
...
定理  设 n 阶方阵 A > 0，max 为 A 的模最大的特征根，则有
...
3.主观：从建立层次结构模型到给出成对比较矩        阵，人主观因素对整个过程的影响很大，这就使得结果难以让所有的决策者接受。
...
|  |  |  |  |  |  |  | P对U |  |  |
| 权 向 量 P 对 C | P1 | 0.595 | 0.082 | 0.429 | 0.634 | 0.167 | 0.299 |  |  |
...
分配见下表：
| 一等奖     比例 | 二等奖比例 | 三等奖比例 | 四等奖金额 | 五等奖金额 | 六等奖金额 | 七等奖金额 |
|---|---|---|---|---|---|---|
| 80% | 10% | 10% | 100 | 10 | 0 | 0 |
| 一等奖     比例 | 二等奖比例 | 三等奖比例 | 四等奖金额 | 五等奖金额 | 六等奖金额 | 七等奖金额 |
|---|---|---|---|---|---|---|
